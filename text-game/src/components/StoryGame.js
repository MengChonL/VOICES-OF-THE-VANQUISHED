...
function StoryGame({ character, storyData, onBackToMenu, onBackToCharacterSelect }) {
  ...
  // 舊的關鍵詞映射（保留作為備份，但優先使用對話文本匹配）
  const imageMap = {
    'popoca': {
      // 句子2: "我叫波波卡...我是Amanteca——羽毛工匠"
      'Amanteca': line1Character,
      '羽毛工匠': line1Character,
      'Huitzilopochtli': line1Character,
      'Tezcatlipoca': line1Character,
      
      // 句子3: "我的兒子，科約特（Coyotl）...格查爾鳥（Quetzal）長尾羽"
      '科約特': line1QuetzalFeather,
      'Coyotl': line1QuetzalFeather,
      '格查爾鳥': line1QuetzalFeather,
      '長尾羽': line1QuetzalFeather,
      
      // 句子4: "『對不起』不能讓格查爾鳥死而復生...大神廟（Templo Mayor）的頂端"
      'Templo Mayor': line1TemploMayor,
      '大神廟': line1TemploMayor,
      '波波卡家族': line1TemploMayor,
      '國庫的貢品': line1TemploMayor,
      ...
      // 句子6: "秩序...Huey Cocoliztli...天花"
      'Huey Cocoliztli': Cocoliztli,
      'Cocoliztli': Cocoliztli,
      '這座城市正在腐爛': Cocoliztli,
      '死亡的惡臭': Cocoliztli,
      
      // 句子7: "羽蛇神（Quetzalcoatl）啊，我的守護神"
      'Quetzalcoatl': line1Quetzalcoatl,
      '羽蛇神': line1Quetzalcoatl,
      '我的守護神': line1Quetzalcoatl,
      '救救她': line1Quetzalcoatl,
      
      // 句子8: "我看著我那佈滿灰塵的傑作"
      '佈滿灰塵': line1QuetzalFeathercrown,
      '傑作': line1QuetzalFeathercrown,
      '神沉默': line1QuetzalFeathercrown,
      
      // 句子9: "我的神死了...作為一個特諾奇提特蘭人（Tenochca）死去"
      '我的神死了': line1AztecWarriors,
      '我的家人死了': line1AztecWarriors,
      'Tenochca': line1AztecWarriors,
      '特諾奇提特蘭人': line1AztecWarriors,
      
      // 句子10: "我走出工坊。我撿起一把掉落的Macuahuitl（黑曜石鋸劍）"
      'Macuahuitl': line1Macuahuitl,
      '黑曜石鋸劍': line1Macuahuitl,
      '我從未殺過生': line1Macuahuitl,
      
      // 新增: "我想起了那個我曾為他製作過一套美洲虎武士服的貴族...特拉科潘（Tlacopan）堤道"
      '美洲虎武士服': line1JaguarWarriorSuit,
      'Tlacopan': line1JaguarWarriorSuit,
      '特拉科潘': line1JaguarWarriorSuit,
      '獨木舟': line1JaguarWarriorSuit,
      
      // 句子11: "我加入了最後一批保衛堤道的戰士"
      '保衛堤道': line1War,
      '戰士': line1War,
      'Teules': line1War,
      '如何格擋': line1War,
      
      // 新增: "我們在惡臭的運河水中潛行...西班牙人的戰船（Brigantines）...特諾奇提特蘭正在燃燒"
      'Brigantines': line1Sainship,
      '戰船': line1Sainship,
      '西班牙人的戰船': line1Sainship,
      '運河水中潛行': line1Sainship,
      '特諾奇提特蘭正在燃燒': line1Sainship,
      '世界的中心': line1Sainship,
      
      // 新增: "門被踢開了。是Teules和他們的特拉斯卡拉盟友。他們看到了我，舉起了劍。他們看到了我身上的病疤（天花後遺症），露出了厭惡的表情。"
      '門被踢開了': line1Macuahuitl,
      '踢開了': line1Macuahuitl,
      '特拉斯卡拉盟友': line1Macuahuitl,
      '特拉斯卡拉': line1Macuahuitl,
      '舉起了劍': line1Macuahuitl,
      '舉起了': line1Macuahuitl,
      '他們看到了我': line1Macuahuitl,
      '看到了我': line1Macuahuitl,
      '病疤': line1Macuahuitl,
      '天花後遺症': line1Macuahuitl,
      '後遺症': line1Macuahuitl,
      '厭惡的表情': line1Macuahuitl,
      '厭惡': line1Macuahuitl,
      ...
      // 句子15: "我活了下來...聖母瑪利亞"
      '冰冷的石頭房間': line1FeatherworkVirginMary,
      '教堂': line1FeatherworkVirginMary,
      '聖母瑪利亞': line1FeatherworkVirginMary,
      '神之子': line1FeatherworkVirginMary,
      '上帝的禮物': line1FeatherworkVirginMary
    },
    'kallpa': {
      // 句子19: "藜麥（Quinoa）煮熟的香氣，和駱馬（Llama）"
      '藜麥': line2Andenes,
      'Quinoa': line2Andenes,
      '駱馬': line2Andenes,
      ...
      // 句子23-24: "薩帕·印加...瓦伊納·卡帕克...太陽之子"
      '薩帕': line2Huayancapac,
      'Sapa Inca': line2Huayancapac,
      '瓦伊納': line2Huayancapac,
      'Huayna Capac': line2Huayancapac,
      '太陽之子': line2Huayancapac,
      'Mit\'a': line2Huayancapac,
      'Inti': line2Huayancapac,
      
      // 句子25: "庫斯科（Cusco）的太陽神殿"
      '庫斯科': line2Cusco,
      'Cusco': line2Cusco,
      '太陽神殿': line2Cusco,
      
      // 句子26: "痘病（天花）" (使用共用的 Cocoliztli)
      '痘病': Cocoliztli,
      '天花': Cocoliztli,
      ...
      '內戰': line2CivilWar,
      '瓦斯卡爾': line2CivilWar,
      'Huáscar': line2CivilWar,
      '阿塔瓦爾帕': line2CivilWar,
      'Atahualpa': line2CivilWar,
      ...
      // 句子33: "Chaquitaclla（安第斯鋤頭）"
      'Chaquitaclla': line2Chaquitaclla,
      '安第斯鋤頭': line2Chaquitaclla,
      '維爾卡班巴': line2Chaquitaclla,
      'Vilcabamba': line2Chaquitaclla,
      '曼科': line2Chaquitaclla,
      'Manco Inca': line2Chaquitaclla,
      
      // 句子35: "會噴火的Illapa（雷電，指火槍）"
      'Illapa': gun,
      '噴火': gun,
      '火槍': gun,
      
      // 句子36: "莊園主（Encomendero）"
      'Encomendero': line2Encomienda,
      '莊園主': line2Encomienda
    },
    'guani': {
      // 句子40: "我叫Guani。我的世界是海洋的蔚藍與叢林的深綠。我的身份是食物的創造者。"
      'Guani': line3Character,
      '海洋的蔚藍': line3Character,
      '叢林的深綠': line3Character,
      '食物的創造者': line3Character,
      
      // 句子41: "我從土裡挖出木薯（Yuca）的根莖。我的兒子，Anani（阿納尼），在我身邊玩耍。"
      '木薯': line3Yuca,
      'Yuca': line3Yuca,
      '根莖': line3Yuca,
      'Anani': line3Yuca,
      ...
      // 句子42: "我觸摸著這根莖。Atabey（天空之母）賜予了它生命，但也藏入了死亡。我的工作，就是馴服死亡。"
      // 注意：對白中可能包含"天空之母"，但只使用"Atabey"作為關鍵詞即可匹配
      'Atabey': line3Atabey,
      '觸摸著這根莖': line3Atabey,
      '馴服死亡': line3Atabey,
      
      // 祈禱場景："(瘋狂地祈禱) Atabey！天空之母！看看你的子民！這是一場考驗，對嗎？是Maboya在作祟！請降下神蹟！驅逐他們！"
      // 注意：只匹配包含Atabey或特定祈禱詞語的場景，避免匹配null標記的句子
      'Atabey！': line3Atabey,
      '看看你的子民': line3Atabey,
      '降下神蹟': line3Atabey,
      '驅逐他們': line3Atabey,
      'Maboya在作祟': line3Atabey,
      
      // 句子44: "我將木薯漿填入Cibucán（編織擠壓管），用力拉扯，看著乳白色的毒汁流出。"
      'Cibucán': line3Cibucan,
      '編織擠壓管': line3Cibucan,
      '木薯漿': line3Cibucan,
      '毒汁流出': line3Cibucan,
      
      // 句子47: "它就變成了生命。這就是Atabey教導我們的平衡。"
      'Casabe': line3Casabe,
      '無毒的木薯粉': line3Casabe,
      '教導我們的平衡': line3Casabe,
      
      // 句子48: "三座漂浮的「巨山」（帆船）到來了。"
      '巨山': line3Ship,
      '帆船': line3Ship,
      '三座漂浮': line3Ship,
      
      // 句子49: "Guani，帶Anani躲起來。他們可能是Maboya（惡靈）。"
      'Maboya': line3Maboya,
      '惡靈': line3Maboya,
      '躲起來': line3Maboya,
      
      // 句子50: "那天晚上，監護主（Encomendero）喝醉了。他闖進了我的小屋。"
      '監護主': line3Encomendero,
      '喝醉了': line3Encomendero,
      '闖進了我的小屋': line3Encomendero,
      '混血的男嬰': line3Encomendero,
      
      // 句子51: "不行！我不能讓他死！Cristianos的惡靈污染了海岸！我必須帶Anani去Bahoruco山區！"
      'Bahoruco': line3Bahoruco,
      'Bahoruco山區': line3Bahoruco,
      'Cristianos的惡靈': line3Bahoruco,
      '污染了海岸': line3Bahoruco,
      
      // 句子52: "我們在海上漂流。Anani的病情時好時壞。我們最終登陸在一片未知的海岸——這裡是加勒比人（Carib）的領地"
      'Carib': line3Carib,
      '加勒比人': line3Carib,
      '海上漂流': line3Carib,
      '未知的海岸': line3Carib,
      ...
      // 新增: "我跪在Zemí（神靈）雕像前，Anani躲在我身後。"
      'Zemí': line3Zemi,
      'Zemi': line3Zemi,  // 無重音版本
      'zemí': line3Zemi,  // 小寫版本
      'zemi': line3Zemi,  // 小寫無重音版本
      '神靈雕像': line3Zemi,
      '雕像前': line3Zemi,
      'Anani躲在我身後': line3Zemi,
      '躲在我身後': line3Zemi
    }
  };
