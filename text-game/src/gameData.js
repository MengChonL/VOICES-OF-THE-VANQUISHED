        ...
        scenes: [
          {
            ...
            dialogue: [
              ...
              { speaker: '旁白', text: '堤道方向傳來雷鳴般的巨響——那是 Teules 的『火蛇』在噴吐死亡。水道被屍體堵塞，鷹與美洲豹戰士的喊殺聲越來越弱……特諾奇提特蘭，正在沉入湖底。' },
    ...
    choices: [
      ...
      },
      {
        ...
        content: [
          ...
          { speaker: '旁白', text: '你的長期投資...迎來了最諷刺的崩潰。在接下來的幾年裡，你成了迪亞哥·德·蘭達（Diego de Landa）最信任的「文化掮客」。你幫助他記錄馬雅曆法（同時也向他匯報哪些祭司仍在秘密活動）。你揭發了數十個隱藏的Chaac 雨神石雕（偶像），你的「虔誠」讓你成為了教會在馬尼（Maní）的重要人物。你太成功了。' },
